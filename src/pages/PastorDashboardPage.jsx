...
import MembersManager from "../components/Pastor/MembersManager";
import PrayerRequestsManager from "../components/Pastor/PrayerRequestsManager";
import PastorDashboardStats from "../components/Pastor/PastorDashboardStats";
import CalendarManager from "../components/Pastor/CalendarManager";
import ScheduleManager from "../components/Pastor/ScheduleManager";
      ...
      default:
        return (
          <div className="flex flex-col items-center justify-center min-h-[400px] bg-white rounded-3xl shadow-sm ring-1 ring-slate-200/50 p-12 text-center border-dashed border-2 border-slate-100">
            ...
            <p className="text-slate-500 max-w-sm mx-auto">La sección administrativa "{activeTab}" estará disponible pronto.</p>
          </div>
        );
    }
  };
