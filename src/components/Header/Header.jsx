        ...
        <div className="max-w-[1000px] mx-auto px-4 sm:px-6">
          <div className="flex items-center justify-between">
            ...
            <a
              ...
              className="flex items-center gap-3 text-slate-900 hover:text-slate-600 transition-colors duration-300"
            >
              <img
                src="/logo-impch.png"
              ...
              />
              <span className="font-sans font-bold text-lg leading-none tracking-tight hidden sm:block">
                IMPCH Pulmahue
              </span>
            </a>
            ...
            <div className="flex items-center gap-3">
              ...
              {!currentUser ? (
                <button
                  ...
                  className="hidden sm:flex items-center justify-center p-2 text-slate-400 hover:text-slate-900 hover:bg-slate-100 transition-colors duration-300"
                ...
                <button
                  ...
                  className="hidden sm:flex items-center justify-center px-5 py-2 bg-slate-900 text-white text-[11px] uppercase tracking-widest font-semibold hover:bg-slate-700 transition-colors duration-300"
                >
                  Portal
                </button>
              )}
