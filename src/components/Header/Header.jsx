    ...
    <>
      <header className="fixed top-0 left-0 right-0 w-full z-[100] shadow-md bg-white border-b border-slate-100">
        ...
        <div className="hidden lg:block bg-[#1e3a5f] text-white/90 h-8">
          <div className="max-w-[1440px] mx-auto h-full px-6 sm:px-8 lg:px-12 flex justify-between items-center text-[10px] uppercase tracking-widest font-semibold">
        ...
        <div className="w-full h-20 flex justify-center py-0">
          <div className="max-w-[1440px] w-full relative flex items-center justify-between px-6 sm:px-8 lg:px-12">
