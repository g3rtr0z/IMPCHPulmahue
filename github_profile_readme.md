...
- **[Inventario ST](https://github.com/g3rtr0z/InventarioST)**: Sistema integral de gestión de inventarios para **Santo Tomás**. Incluye control de roles, generación y escaneo de códigos QR, y reportes en PDF/Excel. Construido con **React 19**, **TypeScript**, **Tailwind CSS** y **Firebase 12**.
